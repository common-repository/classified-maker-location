...
class class_classified_maker_loc_post_meta{
	...
	public function location_meta_options($options = array()){
		...
		$options['Location Info'] = array(
			...
			'classified_maker_loc_country_code'=>array(
				...
				'option_details'=>__('Country, ex: Bangladesh',classified_maker_loc_textdomain),						
		...
		$options = apply_filters( 'classified_maker_loc_filters_meta_options', $options );
	...
	public function location_meta_options_form(){
			...
			foreach($options as $option_key=>$option_info){
				...
				elseif($option_info['input_type'] == 'file'){
					...
					$html_box.= '<input id="upload_button_'.$option_key.'" class="upload_button_'.$option_key.' button" type="button" value="'.__('Upload File',classified_maker_loc_textdomain).'" />';					
...
<script>
	...
	public function meta_boxes_location($post_type) {
			...
			if (in_array($post_type, $post_types)) {
				...
				__('Location Data','classified_maker_loc'),
	...
	public function location_meta_box_function($post) {
       ...
       // $classified_maker_loc_data = get_post_meta($post -> ID, 'classified_maker_loc_data', true);
		...
		//var_dump($classified_maker_loc_salary_currency);
	...
	public function meta_boxes_location_save($post_id){
			...
			//$classified_maker_loc_data = stripslashes_deep($_POST['classified_maker_loc_data']);
	
			
			// Update the meta field.
			//update_post_meta($post_id, 'classified_maker_loc_data', $classified_maker_loc_data);
...
new class_classified_maker_loc_post_meta();